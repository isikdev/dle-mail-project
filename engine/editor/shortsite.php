...
HTML;
	...
	tinymce.init({
		...
		toolbar: [
			...
			'fontformatting forecolor backcolor pasteformat | link dleleech anchor | dleemo | {$image_upload[0]} {$implugin} dlemp dlaudio dletube | dlequote dlespoiler dlehide codesample pagebreak dlepage | removeformat | code'
		],
