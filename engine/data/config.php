...
'home_title' => 'Исследования рынков по странам - Alto Consulting Group (ACG)',

'http_home_url' => 'https://alto-group.com/',

'only_ssl' => '1',

'description' => 'Проведение маркетинговых исследований рынков в России и по странам. Готовые обзоры рынков, анализ импорта и экспорта по кодам ТНВЭД, анализ государственных и коммерческих закупок по 44-ФЗ и 223-ФЗ - Alto Consulting Group (ACG)',

'keywords' => 'проведение маркетинговых исследований, привлечение финансирования, ТЭО, разработка финансовой модели, анализ рынка, обзор рынка, разработка бизнес-планованализ государственных и коммерческих закупок по 44-ФЗ и 223-ФЗ',

'short_title' => 'Alto Consulting Group (ACG)',

'start_site' => '1',

'date_adjust' => 'Asia/Yekaterinburg',
...
'admin_mail' => 'info@alto-group.ru',

'mail_title' => 'Alto Consulting Group (ACG)',
...
'key' => '137248bc1159ab569ee26480ab4bb3a4',
