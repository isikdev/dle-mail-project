...
HTML;
    ...
    <td>
    <div class="editor-panel"><div class="' . $extra_class . '">' . $bb_panel . '<textarea class="' . $editor_class . '" style="width:100%;max-width:950px;height:200px;" id="short_' . $i . '" name="content[' . $i . '][short]"' . $extra_textarea . '>' . $content['description'] . '</textarea></div></div>
