...
echo <<<HTML
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<textarea style="width:100%; height:3.75rem;" name="banned_descr" class="classic">{$row['descr']}</textarea>
				  </div>
				 </div>
				<div class="list-group-divider"></div>
				<div class="form-group">
...
<table width="99%">
    ...
    <tr>
        ...
        <td colspan="2"><textarea style="width:100%; height:3.75rem;" name="banned_descr" class="bk">{$row['descr']}</textarea></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
