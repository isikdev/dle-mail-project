...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="form-group" id="select_options">
		  ...
		  <div class="col-md-10 col-sm-9">
			<textarea class="classic width-400" style="height: 6.25rem;" name="editedxfield[6_select]"><?php echo ($editedxfield[3] == "select") ? $editedxfield[6] : ""; ?></textarea><div class="text-muted text-size-small"><?php echo $lang['xfield_xfsel']; ?></div>
		  </div>
		 </div>	
		<div class="form-group">
