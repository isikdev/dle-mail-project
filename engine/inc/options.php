...
HTML;
	...
	showRow($lang['opt_sys_aifdl'], $lang['opt_sys_aifdld'], "<input  type=\"text\" class=\"form-control\"  name=\"save_con[iframe_domains]\" value=\"{$config['iframe_domains']}\" >");
...
<div id="files" class="panel panel-flat" style='display:none'>
  ...
  <table class="table table-striped">
HTML;
	showRow( $lang['opt_sys_imfs'], $lang['opt_sys_imfsd'], makeDropDown( array ("0" => $lang['opt_sys_imfs_1'], "1" => $lang['opt_sys_imfs_2'], "2" => $lang['opt_sys_imfs_3'], "3" => $lang['opt_sys_imfs_4'], "4" => $lang['opt_sys_imfs_5'], "5" => $lang['opt_sys_imfs_6'], "6" => $lang['opt_sys_imfs_7'] ), "save_con[file_driver]", "{$config['file_driver']}", "onchange=\"ShowOrHideRemote(this.value)\"" ) );
	...
	if( !$config['ftp_password'] ) $pass_hidden = ''; else  $pass_hidden = $lang['pass_hidden'];
	showRow( $lang['opt_sys_imfsfpp'], $lang['opt_sys_imfsfppd'], "<input  type=\"text\" class=\"form-control\" name='save_con[ftp_password]' value=\"\" placeholder=\"{$pass_hidden}\">", "ftp-server" );

	showRow($lang['opt_sys_imfwe'], $lang['opt_sys_imfwed'], "<input  type=\"text\" class=\"form-control\" name='save_con[webdav_baseurl]' value=\"{$config['webdav_baseurl']}\" >", "webdav-server");
	showRow($lang['opt_sys_imfweu'], $lang['opt_sys_imfweud'], "<input  type=\"text\" class=\"form-control\" name='save_con[webdav_user]' value=\"{$config['webdav_user']}\" >", "webdav-server");

	if (!$config['webdav_pass']) $pass_hidden = ''; else $pass_hidden = $lang['pass_hidden'];
	showRow($lang['opt_sys_imfwep'], $lang['opt_sys_imfwepd'], "<input  type=\"text\" class=\"form-control\" name='save_con[webdav_pass]' value=\"\" placeholder=\"{$pass_hidden}\">", "webdav-server");
	...
	showRow( $lang['opt_sys_imfsfpa'], $lang['opt_sys_imfsfpad'], "<input  type=\"text\" class=\"form-control\" name='save_con[ftp_path]' value=\"{$config['ftp_path']}\" >", "remote-server webdav-hidden" );
	...
	showRow($lang['opt_sys_fa'], $lang['opt_sys_fad'], makeDropDown(array("public" => $lang['files_public'], "private" => $lang['files_private']), "save_con[files_access]", "{$config['files_access']}"));
	...
	showRow( $lang['opt_sys_maxfilesh'], $lang['opt_sys_maxfileshd'], "<input  type=\"text\" class=\"form-control\" style=\"max-width:150px; text-align: center;\"  name='save_con[file_chunk_size]' value=\"{$config['file_chunk_size']}\">" );
...
HTML;
	...
	if ($config['webdav_pass'] AND !$save_con['webdav_pass']) {
		$save_con['webdav_pass'] = $config['webdav_pass'];
	}
