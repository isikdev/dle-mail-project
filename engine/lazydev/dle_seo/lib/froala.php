...
jQuery(function($){
    $('.wysiwygeditor').froalaEditor({
        ...
        imageAllowedTypes: ['jpeg', 'jpg', 'png', 'gif', 'webp', 'jfif'],
        imageDefaultWidth: 0,
        imageInsertButtons: ['imageBack', '|', 'imageByURL'{$image_q_upload}],
        imageUploadURL: 'engine/lazydev/dle_seo/admin/ajax/upload.php',
        imageUploadParam: 'qqfile',
        imageUploadParams: { "subaction" : "upload", "seoId" : "{$idSeo}", "area" : "short_story", "author" : "{$p_name}", "mode" : "quickload", "user_hash" : "{$dle_login_hash}"},
