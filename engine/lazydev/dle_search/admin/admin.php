...
$speedbar = '<li><i class="fa fa-home position-left"></i><a href="?mod=' . $modLName . '" style="color:#2c82c9">' . $dleSearchLangVar['admin']['speedbar_main'] . '</a></li>';
if ($action !== 'main') {
    $speedbar .= '<li>' . $dleSearchLangVar['admin']['speedbar_' . $action] . '</li>';
}
