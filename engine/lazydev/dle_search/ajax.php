...
$thisUrl = trim(strip_tags($_POST['thisUrl']));
$modSearch = 'ajax';
...
if ($dle_hash != $dle_login_hash) {
	echo Helper::json(['text' => $dleSearchLangVar['admin']['ajax']['error'], 'error' => 'true']);
    die();
}
...
include ENGINE_DIR . '/lazydev/dle_search/index.php';
